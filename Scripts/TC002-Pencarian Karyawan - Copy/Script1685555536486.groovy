...
WebUI.click(findTestObject('Page_OrangeHRM/select_Job_Title'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Search'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_First ( Middle) Name_oxd-icon bi-sort-alp_1f583c'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Decending'))
